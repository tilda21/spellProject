...
class App extends React.Component {
  ...
  render() {
    ...
    const gradients = {
      ...
      // Christmas: "linear-gradient(45deg, rgba(79,148,56,1) 0%, rgba(208,74,62,0.9481933250855864) 80%)",
      Christmas: "linear-gradient(45deg, rgba(89,172,62,1) 0%, rgba(227,61,46,1) 80%)",
